...
class TopKEvaluator(object):
    ...
    def evaluate(self, batch_matrix_list, eval_data, is_test=False, idx=0):
        ...
        """
        pos_items = eval_data.get_eval_items() # pos items of each user, list of arrays
        pos_len_list = eval_data.get_eval_len_list() # an array, len=num user, indicate the length of pos items of each user
